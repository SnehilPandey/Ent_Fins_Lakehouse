...
# MAGIC 
# MAGIC Resources
# MAGIC * Documentation:  [Azure](https://docs.microsoft.com/en-us/azure/databricks/spark/latest/structured-streaming/auto-loader)
...
temp_dir = 'dbfs:/tmp/snehil/autoloader'
